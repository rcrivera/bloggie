class CommentsController < ApplicationController
  ...
  def new
    ...
    Rails.logger.info "BLOG_ID = #{@post_id}"
  end
  ...
  def update
    ...
    respond_to do |format|
      if @comment.update(comment_params)
        Rails.logger.info "UPDATE = #{post_id}"


        format.html { redirect_to :controller => 'posts', :action => 'show', :id => post_id, notice: 'Comment was successfully updated.' }
